class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('charizard', 'img/charizard.png')
    ...
    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'mickey_font', 'THE ODYSSEY', 100).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY, 'mickey_font', 'Press SPACE to start', 60).setOrigin(0.5)
